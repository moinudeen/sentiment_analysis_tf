...
DATA_PATH_POS = [ '/home/moinudeen/dev/ml/DataSets/aclImdb/train/pos/', 
        '/home/moinudeen/dev/ml/DataSets/aclImdb/test/pos/' ]
DATA_PATH_NEG = [ '/home/moinudeen/dev/ml/DataSets/aclImdb/train/neg/', 
        '/home/moinudeen/dev/ml/DataSets/aclImdb/test/neg/' ]
...
def process_data():
    ...
    np.save('idx2w.npy', idx2w)
    np.save('w2idx.npy', w2idx)
